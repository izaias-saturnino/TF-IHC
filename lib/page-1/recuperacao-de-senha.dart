                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Container(
                            // frame32Jb1 (66:701)
                            margin: EdgeInsets.fromLTRB(45*fem, 0*fem, 45*fem, 335*fem),
                            width: double.infinity,
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                          ...
                          Container(
                            // frame33VQb (66:702)
                            padding: EdgeInsets.fromLTRB(46*fem, 30*fem, 46*fem, 22*fem),
                            width: double.infinity,
                            height: 100*fem,
                            decoration: BoxDecoration (
                              borderRadius: BorderRadius.circular(20*fem),
                            ...
                            child: Container(
                              ...
                              child: Center(
                                child: Column(
                                  children: <Widget>[
                                    // TODO: clicar no botão só funciona ao
                                    //  clicar no texto. Corrigir para que o
                                    //  toque funcione no botão todo
                                    TextButton(
                                      onPressed: () {
                                        Navigator.pushNamed(context, '/recuperacao-senha-2');
                                      },
                                      child: Text(
                                        'Enviar',
                                        style: SafeGoogleFont (
